...
"""
            ...
            response = self.anthropic_client.messages.create(
                ...
                messages=[{
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": f"Analyze this image from an ESG/sustainability report. This image appears in the context: {chunk.content[:200]}... Describe what you see, any data, charts, trends, or key information visible. Focus on details that would help answer questions about the document content."
                        }
                    ]
                }]
            )
    ...
    def _generate_answer_with_claude(self, query: str, chunks: List[ProcessedChunk], 
        ...
        prompt = f"""
Based on the following content from an ESG/sustainability document, answer the user's question comprehensively.
...
def main():
    ...
    rag = AnthropicOnlyRAG(anthropic_api_key="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")
    
    # Test image naming convention first
    json_filename = "extracted_content/JSON/adm-2022-short.json"  # Replace with your actual JSON filename
    print("="*60)
    ...
    # Example queries
    queries = [
        "What are the workplace safety metrics?",
        "Show me the climate change data", 
        "What does the sustainability chart demonstrate?"
    ]
